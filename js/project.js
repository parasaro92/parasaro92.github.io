function gallery(){
  ...
  $('.ajs1').click(function(ev) { ev.preventDefault(); bootbox.alert('<h4 class="text-center">Shopping Site</h4><hr><img class="img-responsive" src="images/shoppix.png"><br/><p class="text-center">You can add new items and Buyer can see the contact details.</p><div class="col-md-offset-3 col-md-9"><a href="https://github.com/parasaro92/shoppix" target="_blank"><button type="button" class="btn btn-success">Github URL</button></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://parasaro92.github.io/shoppix/#/classifieds" target="_blank"><button type="button" class="btn btn-danger">Launch Demo</button></a></div>'); });
  $('.ajs2').click(function(ev) { ev.preventDefault(); bootbox.alert('<h4 class="text-center">Event Management</h4><hr><img class="img-responsive" src="images/event.png"><br/><p class="text-center">You can create, manage and edit events.  </p><div class="col-md-offset-3 col-md-9"><a href="https://github.com/parasaro92/Event-Management" target="_blank"><button type="button" class="btn btn-success">Github URL</button></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://parasaro92.github.io/Event-Management" target="_blank"><button type="button" class="btn btn-danger">Launch Demo</button></a></div>'); });
  ...
  $('.ajs5').click(function(ev) { ev.preventDefault(); bootbox.alert('<h4 class="text-center">Football-Frontier</h4><hr><img class="img-responsive" src="images/foot.png"><br/><div class="col-md-offset-3 col-md-9"><a href="https://github.com/parasaro92/Football-Frontier" target="_blank"><button type="button" class="btn btn-success">Github URL</button></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://parasaro92.github.io/Football-Frontier/#/" target="_blank"><button type="button" class="btn btn-danger">Launch Demo</button></a></div>'); });
