function gallery(){
  ...
  $('.p2').click(function(ev) { ev.preventDefault(); bootbox.alert('<h4 class="text-center">PSD to HTML</h4><hr><img class="img-responsive" src="images/psd1.png"><br/><div class="col-md-offset-3 col-md-9"><a href="https://github.com/parasaro92/psd2html" target="_blank"><button type="button" class="btn btn-success">Github URL</button></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://parasaro92.github.io/psd2html/" target="_blank"><button type="button" class="btn btn-danger">Launch Demo</button></a></div>'); });
